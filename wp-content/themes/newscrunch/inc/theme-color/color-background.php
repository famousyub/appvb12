            ...
            { 
                ...
                { 
                    ...
                    <style type="text/css">
                        ...
                        body .spnc-category-page .spnc-blog-cat-wrapper .spnc-first-catpost .spnc-cat-links a.newscrunch_category_<?php echo esc_attr($spnc_cid); ?>
                                {
                ...
                // new user
                    ...
                    <style type="text/css">
                        body.newscrunch #page .spnc-cat-links a.newscrunch_category_<?php echo esc_attr($term->term_id);?>
                            {
                                background: <?php echo esc_attr( get_theme_mod('newscrunch_category_'.$term->term_id, '#669c9b') ); ?>;
                            }
                        body .spnc-category-page .spnc-blog-cat-wrapper .spnc-first-catpost .spnc-cat-links a.newscrunch_category_<?php echo esc_attr($term->term_id); ?>
                                {
                                    color: <?php echo esc_attr( get_theme_mod('newscrunch_category_'.$term->term_id, '#669c9b') ); ?>;
                                }
                    </style>
                <?php }
        }
