    ...
    class Newscrunch_Single_Post_Customize_Control extends WP_Customize_Control {
            public function render_content() { ?>
                <div class="newscrunch-premium">
                    ...
                    <a target="_blank" href="<?php echo esc_url('https://helpdoc.spicethemes.com/newscrunch/blog-archive-single/#single-post?ref=customizer'); ?>" class=" button-primary"><?php echo esc_html( 'Learn More'); ?></a>
                </div>
        <?php }
    }
