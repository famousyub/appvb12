	        ...
	        <div class="notice-content-wrap">
	            <div class="notice-content">
	                ...
	                <ol class="admin-notice-up-list">
	                    <li><?php echo esc_html__('Added Slider Animation Speed feature in PRO', 'newscrunch' ); ?></li>
	                    <li><?php echo esc_html__('Added Enable/Disable Post Navigation feature for single post in PRO', 'newscrunch' ); ?></li>
	                </ol>
