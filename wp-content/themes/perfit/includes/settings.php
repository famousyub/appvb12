    ...
    $smt_default_options = array(
		...
		'social'=>array(
			...
			'content'=>array(
				...
				'socials' => array(
					'type'=>'multiselect', 'name'=>'socials', 'value'=>array( 'facebooklike', 'twitter', 'pinterest' ), 'title'=>'Social services', 
					'params'=>array(
			...
			'content'=>array(
				...
				'error'=>array(
					...
					'content'=>array(
						...
						'emailfail'=>array(
							'type'=>'text','name'=>'emailfail','value'=>'Message hasn\'t been sent.','title'=>'Notification of an email delivery failure'
						)
					)
				),
				'comments'=>array(
