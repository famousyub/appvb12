...
if ( ! class_exists( 'Spice_Post_Slider_Type' ) ) {
  ...
  class Spice_Post_Slider_Type
  {
    ...
    public function __construct()
    {
      ...
      // add_action( 'admin_print_scripts-post-new.php', array( $this , 'sps_admin_script' ), 11 );
      // add_action( 'admin_print_scripts-post.php', array( $this , 'sps_admin_script' ), 11 );
    }
    ...
    { ?>
        <img style="max-width:100%;height:auto" src="<?php echo esc_url(SPS_URL.'assets/img/review.jpg');?>" /> 
    ...
    { ?>
        <img style="max-width:100%;height:auto" src="<?php echo esc_url(SPS_URL.'assets/img/support.jpg');?>" />
    ...
    { ?>
        <img style="max-width:100%;height:auto" src="<?php echo esc_url(SPS_URL.'assets/img/docs.jpg');?>" /> 
    ...
    { ?>
        <img style="max-width:100%;height:auto" src="<?php echo esc_url(SPS_URL.'assets/img/upgrade-pro.jpg');?>" />
